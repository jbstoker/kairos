...
class TestWatchPage(unittest.TestCase):
    ...
    def test_service_worker_caches_the_watch_face(self):
        ...
        # Version-agnostic: any kairos-vN cache name is fine — the version
        # bumps whenever the app shell changes (e.g. a new cached script).
        self.assertRegex(sw, r"kairos-v\d+")
