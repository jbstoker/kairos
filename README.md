...
Configure → 🌍 Show Light Cone, off by default) shows a **Sun-originating
light cone**: two lines trace its edges from the Sun bead to the Earth's
horizon, with a soft fill between them; the opacity maps day / twilight /
